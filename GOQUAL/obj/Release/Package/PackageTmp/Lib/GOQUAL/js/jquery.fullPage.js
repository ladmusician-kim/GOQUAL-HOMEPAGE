	...
	$.fn.fullpage = function(options) {
		...
		*/
		...
		if (options.navigation) {
		    // 동진
		    //$('#productPage').append('<div id="fp-nav"><ul></ul></div>');
		...
		*/
		...
		$.fn.fullpage.reBuild = function(){
			...
			$('.fp-section').each(function(){
				...
				if (options.verticalCentered) {
				    $(this).find('.fp-tableCell').css('height', getTableHeight($(this)) - 89 + 'px');
				}
				$(this).css('height', windowsHeight + 'px');
		...
		*/
		...
		function addTableClass(element) {
		    var height = getTableHeight(element) - 88;
			element.addClass('fp-table').wrapInner('<div class="fp-tableCell" style="height:' + height + 'px;" />');
		}
